  ...
  head: () => ({
    meta: [
      ...
      { title: "Dayflow — Every workday, perfectly aligned." },
      {
        name: "description",
        content:
          "Dayflow is the premium HR platform unifying attendance, leave, payroll, employee profiles and HR analytics in one beautifully designed workspace.",
      },
      ...
      { property: "og:title", content: "Dayflow — Every workday, perfectly aligned." },
      {
        ...
        content:
          "Attendance, leave, payroll, people and HR analytics — one unified, beautifully designed workspace.",
      },
